    ...
    <div class="details container-product">
        ...
        <div class="right">
            ...
            <form class="form-product">
                <a href="?act=dattuor&name=<?=$result['name']?>&day_start=<?=$result['day_start']?>&day_end=<?=$result['day_end']?>&price_young=<?=$result['price_young']?>&diem_den=<?=$result['diem_den'] ?>&noi_bd=<?=$result['noi_bd']?>" class="addCart" style="txext-decoration: none; text-transform: uppercase; font-weight: bold;">đặt tour</a>
